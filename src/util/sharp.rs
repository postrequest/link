...
pub fn get_sharp_path(tool: String) -> String {
	...
	let home_dir = match std::env::var("HOME") {
        Err(e)      => { println!("{}", e); return "".to_string()},
        Ok(home)    => home,
    };
...
pub fn sharp_link_help() {
	...
	println!("  sharp AtYourService               C# .NET Assembly for Service Enumeration @mitchmoser");
	...
	println!("  sharp LockLess                    Allows for the copying of locked files. @GhostPack");
	...
	println!("  sharp SharpHound3                 C# Rewrite of the BloodHound Ingestor. @BloodHoundAD");
	...
	println!("  sharp SharpStay                   .NET project for installing Persistence. @0xthirteen");
	...
	println!("  sharp SharpUp                     C# port of various PowerUp functionality. @GhostPack");
	...
	println!("  sharp StandIn                     C# based small AD post-compromise toolkit. @FuzzySec");
